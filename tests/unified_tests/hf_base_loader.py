# File: hf_base_loader.py
# tests/unified_tests/hf_base_loader.py
...
class DatasetReader:
    ...
    def load_dataset(self, dataset_name: str) -> Dataset:
        try:
            ...
            # If not in cache, load from source and save to cache
...
class HFBaseLoader:
    ...
    def _load_cache_dataset(
        ...
        try:
            return load_dataset(dataset_name, subset, cache_dir=str(self.paths.cache_dir))
        except Exception as e:
